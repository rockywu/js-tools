...
;APF.Namespace.register("kfstouch.plugin");
;(function(T) {
    "use strict";
    var CUI,
        Tools = {
                ...
                if (xhr.readyState == 4) {
                    if (xhr.status == 200) {
                        ...
                        if (!self.filesFilter.length) {
                            ...
                            T.trackEvent('ugcimgMonitor',runtime,'m_anjuke-npv');
                ...
                if(isMobile.iOS()){
                    ...
                    EXIF.getData(file, function() {
                        ...
                        tmpImg.onload=function(){
                            ...
                            self.doUpload(index, file, data, "kfstouch-someboundary");
                        }
                    });
                }else{
